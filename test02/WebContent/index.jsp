...
$(function() {
	...
	$('#failtoLogin').css("color","red");
//////////////////////////////////////////////////////////////////////////////////
	var checkId=false;//id가 유효하지 않은 상태. 비었거나 중복이거나
	$('#joinId').keyup(function(){
		var id = $('#joinId').val();
		$.ajax({
			url: "/RealTimeNews_tm/ajax.do",
			type: "post",
			...
			error: function(exception){
				alert("ajax error : "+exception.message);
			}
		})
	})
/////////////////////////////////////////////////////////////////////////////////////////////
	var checkEmail=false;//id가 유효하지 않은 상태. 비었거나 중복이거나
	...
	//////////////////////////////////////////////////////////////////////////////
	$('#joinConfirm_password').keyup(function(){
		if($('#joinPassword').val()==$('#joinConfirm_password').val()){
							...
							<div class="col-lg-12">
								<form id="login-form" action="member.do" method="post" role="form" style="display: block;">
									...
									<div class="form-group">
										<input type="text" name="id" id="id" tabindex="1" class="form-control" placeholder="ID" value='<c:if test="${sessionScope.rememberId != null}">${sessionScope.rememberId}</c:if>'>
									</div>
									<div class="form-group">
									...
									<c:if test="${login_flag==false}">
										<p id="failtoLogin">fail to log-in</p>
									</c:if>
									<div class="form-group">
										<div class="row">
											<div class="col-lg-12">
