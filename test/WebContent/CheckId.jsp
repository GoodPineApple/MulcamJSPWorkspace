			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-check">
					<div class="panel-heading">
						<div class="row">
							<p>
								<a class="active" id="check-form-link">Check Id</a>
							</p>
						</div>
					</div>
					<i class="glyphicon glyphicon-home navy"></i>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="check-submit" id="check-submit" tabindex="4" class="form-control btn btn-check" value="Check Id">
											</div>
										</div>
									</div>
								</form>
