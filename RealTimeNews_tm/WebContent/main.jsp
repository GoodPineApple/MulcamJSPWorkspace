									...
									if (data != 'empty') {
										$(data).find('news').each(function() {
											...
											if (id == loginId&& state == 'true') {
												...
												result += "<span>";
												result += "<button type='button' id='btnCo' value="+newsNo+">등록</button>";
												result += "</span>";
															
												result += "<span>";
												result += "<button type='button' class='moreCo' id='10' value="+newsNo+">더보기</button>";
												result += "</span>";
					...
					$.ajax({
						...
						success: function(data){
							...
							$(data).find('comment').each(function() {
								...
								var comment ="<tr>";
								comment += "<td>" + id +":"+"</td>";
								comment += "<td>" + content + "</td>";
								comment += "<td>" + writeDate + "</td>";
								comment += "</tr>";
			...
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<div>
					<fieldset>
						...
						<textarea id="messageWindow" rows="20" cols="40"
							readonly="readonly"></textarea>
						<br> <input type="text" id="inputMessage" /> <input
							type="submit" value="전송" onclick="send()" tabindex="0" />
					</fieldset>
				</div>
			</div>
